export const layoutResponseCorreiosForTests = ` <!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
...
<title>Preços e Prazos</title>
<meta name="description" content="[page]" />
<meta name="keywords" content="" />
<script type="text/javascript"> 
pageid = 'E0F76A1F-5056-9163-89D165CB4AC546F7'; 
</script>
<noscript>
<p>identificador da página</p>
</noscript>
<base href="https://www2.correios.com.br/"> 
<script type="text/javascript" src="/ruxitagentjs_ICA7NVfgqrux_10303241106123517.js" data-dtconfig="app=62a275fc1f615475|cuc=88037dhn|mel=100000|featureHash=ICA7NVfgqrux|lastModification=1733855550665|tp=500,50,0|rdnt=1|uxrgce=1|agentUri=/ruxitagentjs_ICA7NVfgqrux_10303241106123517.js|reportUrl=/rb_bf62475kpy|rid=RID_2046061993|rpid=686362525|domain=correios.com.br"></script><link rel="icon" href="home2014/img/icon.png" type="image/gif"/>
...
<!-- scripts -->
  ...
  <script>
    ...
    })(window,document,'script','dataLayer','GTM-WNPMDD2');
  </script>
  <!-- End Google Tag Manager -->
  
  <noscript><p>Biblioteca de efeitos</p></noscript> 
...
<noscript>
  <iframe src="https://www.googletagmanager.com/ns.html?id=GTM-WNPMDD2"height="0" width="0" style="display:none;visibility:hdden">
...
<div class="acesso_rapido">
  ...
  <div class="wrap">
    <ul class="tabs-list">
      ...
      <li class="current">
	  	<a href="default.cfm"><h2>Sistemas</h2></a>
	  </li>
    </ul>
  </div>
...
<h3>Sistemas</h3>
<ul>
	<li><a href="sistemas/precosPrazos/">Calculador de preços e prazos nacionais</a></li>	
	<li><a href="https://efi.correios.com.br/app/simulaPrecoPrazoInternacional/index.php">Calculador de preços e prazos internacionais</a></li>
	
	<li><a href="https://www.correios.com.br/enviar/encomendas">Serviços Nacionais</a></li>
	
	<li><a href="https://www.correios.com.br/enviar/encomendas/internacional">Serviços internacionais</a></li>
	
	
	<li><a href="sistemas/precosPrazos/entregadiferenciada/">Entrega diferenciada por CEP</a></li>
	
	
	<li><a href="https://www.correios.com.br/receber/prazo-de-guarda">Prazo de guarda de objetos nacionais</a></li>
</ul> 
</span>
<!-- Fim Menu vertical -->
</div>
...
<script type="text/javascript" language="JavaScript" src="sistemas/precosPrazos/js/jquery.colorbox-min.js"></script>

<script language="javascript">
function buscaCep()
{
$.colorbox({width:"1000px", height:"600px", iframe:true, href:"https://buscacepinter.correios.com.br"});
}
function buscaInformacaoData()
{
$.colorbox({width:"600px", height:"300px", iframe:true, href:"/sistemas/precosprazos/informacaoData.cfm"});
}
function buscaFormato ()
{
$.colorbox({width:"600px", height:"300px", iframe:true, href:"/sistemas/precosprazos/Formato.cfm"});
}
</script>

<noscript>	  
<meta http-equiv="refresh" content="1; URL=http://www2.correios.com.br/sistemas/precosPrazos/javascriptDesabilitado.cfm">	
</noscript>	
<!--  091020140855 -->



<input name="cidadeOrig" type="hidden" value="Criciúma /SC">

<input name="cidadeDest" type="hidden" value="Cabedelo /PB">
<!--https://api.correios.com.br/prazo/v1/nacional/--> 					
<script language="javascript">
function buscaInformacaoFeriado()
{

//								
$.colorbox({width:"600px", height:"400px", iframe:true, href:"https://www2.correios.com.br/sistemas/precosPrazos/buscaFeriados.cfm?feriadosN=241225&feriadosM=&feriadosP="});							

}
</script>
<div class="info information"><img src="home2014/img/layout/trans.gif" width="25px" height="25px" alt=""/>Feriado no período de entrega.<a class="cssLink" href="javascript:buscaInformacaoFeriado();">Clique aqui para ver.</a></div>							

	<!-- 01102014-->
	<!-- Versão de 07/03/2016 -->
	
	<!--https://api.correios.com.br/preco/v1/nacional/--> 

		<table class="comparaResult" style="width:648px">
							
				<tbody>
					
					 

					<tr class="dragDropSection">
						<td></td>
						
											<td><img title="PAC" src="home2014/img/etiquetaProdutos/pac.png" alt="" /></td>
										
					</tr>
					
					 
						<tr class="destaque">
							<th>Prazo de entrega <small>Para postagens em <br /> 14/12/2024</small></th>
							
											
												
												
													<td>Dia da Postagem + 10 dias úteis</td>
				...
				<tfoot>
						<tr class="destaque">
							...
							<th>Valor total <br> (Sem Embalagem):</th>
			...
			<div class="info information"><img src="home2014/img/layout/trans.gif" width="25px" height="25px" alt=""/>
				...
				<div class="info information"><img src="home2014/img/layout/trans.gif" width="25px" height="25px" alt=""/>
					Para fins de contagem do prazo de entrega, sábados, domingos e feriados não são considerados dias úteis.		
				</div>
				<div class="info information"><img src="home2014/img/layout/trans.gif" width="25px" height="25px" alt=""/>
					Postagem ocorrida após o horário limite de postagem (DH), será acrescido 1 (um) dia útil ao prazo padrão de entrega.				
				</div>
	          
         						
		<div id="abreFecha"	class="text-right icoCollapse expandAll">
			<a id="abreTudo" style="display: block;" href="javascript:void(0);"	onclick="ddaccordion.expandall('expodados'); return false"></a>
			<a style="display:none;" href="javascript:void(0);"	onclick="ddaccordion.collapseall('expodados'); return false"></a>
		</div>
					
		<div class="expodados" headerindex="0h"> <b>Dados do objeto simulado.</b></div>
		<div class="contentexpodados" contentindex="1c" style="display: none;">			
		
		<table class="comparaResult" style="width:640px">
				...
				<tbody>
					...
					<tr>
						<th>Endereço</th>
						<td>Rua Seila o que Pedro seila - até 000 - lado ímpar</td>
						<td>Rua José do Seila </td>						
					</tr>
...
<div class="footer">
  <div class="wrap">
      ...
      <div class="column-footer">
        <h3><a target="_blank" href="https://faleconosco.correios.com.br/faleconosco/app/index.php">
        Fale Conosco</a></h3>
        <ul>
          <li class="node"><a href="https://faleconosco.correios.com.br/faleconosco/app/index.php ">Manifestação via Internet</a>
            <ul>
              <li><a href="https://faleconosco.correios.com.br/faleconosco/app/index.php ">Fale Conosco pelo site</a></li>
            </ul>
          </li>
          ...
          <li class="node"> <a href="https://www.correios.com.br/falecomoscorreios/ouvidoria">Ouvidoria</a> </li>
        </ul>
      </div>
      <div class="column-footer">
        ...
        <ul>
          ...
          <li><a href="https://www2.correios.com.br/sistemas/rastreamento/default.cfm">Rastreamento de objetos</a></li>
          <li><a href="https://saladeimprensa.correios.com.br/">Sala de Imprensa</a></li>
          ...
          <li><a href="https://www.correios.com.br/acesso-a-informacao/acoes-e-programas/carta-de-servicos-aos-usuarios/carta-de-servicos-aos-usuarios">Carta de servi&ccedil;os ao cidad&atilde;o</a></li>
          <li><a href="https://www.correios.com.br/falecomoscorreios/canais-de-denuncia">Denúncia</a></li>                      
          <li><a href="https://www.gov.br/mcom/pt-br">Minist&eacute;rio das Comunica&ccedil;&otilde;es</a></li>
        </ul>
      </div>
      <div class="column-footer">
        ...
        <ul>
          ...
          <li><a href="https://www.correios.com.br/app-dos-correios">Correios Mobile</a></li>
...
<!-- contentobjects: page generated at 2024-08-26 09:17 AM -->`;
